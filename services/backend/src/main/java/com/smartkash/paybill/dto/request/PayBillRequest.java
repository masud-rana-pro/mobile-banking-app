package com.smartkash.paybill.dto.request;
...
public record PayBillRequest(
        ...
        @Size(max = 40, message = "Biller code must be 40 characters or fewer.")
        String billerCode,

        @NotBlank(message = "Bill account number is required.")
        @Size(max = 40, message = "Bill account number must be 40 characters or fewer.")
